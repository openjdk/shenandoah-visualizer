...
public class RenderLegendTest {
    ...
    public void test() throws IOException {
        ...
        new ShenandoahVisualizer.RenderPlayback(new DataLogProvider("src/test/resources/regions-6425.log", new SnapshotHistory()), null, new ToolbarPanel(true)).renderLegend(g);
